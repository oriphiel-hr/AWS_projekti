...
export default function UserTypesFlowcharts() {
  ...
  const ProviderJourneyFlowchart = () => (
    <ZoomableSVG viewBox="0 0 1200 1700">
      ...
      {/* Prihvaćena */}
      <rect x="600" y="840" width="200" height="80" rx="5" fill={successColor} stroke={borderColor} strokeWidth="2" />
      <text x="700" y="860" textAnchor="middle" fontSize="14" fontWeight="bold" fill="white">
        ✓ PRIHVAĆENA
      </text>
      <text x="700" y="880" textAnchor="middle" fontSize="12" fill="white">
        Status: PRIHVAĆENA
      </text>
      <text x="700" y="900" textAnchor="middle" fontSize="12" fill="white">
        Chatroom se kreira
      </text>
      ...
      {/* Chatroom - ZAHTIJEVA OBA SUDIONIKA */}
      <rect x="600" y="1000" width="200" height="120" rx="5" fill={primaryColor} stroke={borderColor} strokeWidth="3" />
      <text x="700" y="1025" textAnchor="middle" fontSize="14" fontWeight="bold" fill="white">
        💬 CHATROOM
      </text>
      <text x="700" y="1045" textAnchor="middle" fontSize="11" fill="white">
        ⚠️ ZAHTIJEVA:
      </text>
      <text x="700" y="1065" textAnchor="middle" fontSize="10" fill="white">
        • Korisnik (vlasnik posla)
      </text>
      <text x="700" y="1080" textAnchor="middle" fontSize="10" fill="white">
        • Pružatelj (prihvaćena ponuda)
      </text>
      <text x="700" y="1095" textAnchor="middle" fontSize="10" fill="white">
        • Oboje moraju biti aktivni
      </text>
      <text x="700" y="1110" textAnchor="middle" fontSize="11" fill="white">
        ✓ Automatski kreiran
      </text>
      ...
      {/* Oba sudionika u chatu */}
      <rect x="550" y="1160" width="300" height="120" rx="5" fill={boxColor} stroke={borderColor} strokeWidth="2" />
      <text x="700" y="1185" textAnchor="middle" fontSize="12" fontWeight="bold" fill={textColor}>
        👥 OBA SUDIONIKA
      </text>
      <text x="700" y="1205" textAnchor="middle" fontSize="11" fill={textColor}>
        Komunikacija u chatroomu
      </text>
      <text x="700" y="1220" textAnchor="middle" fontSize="11" fill={textColor}>
        • Razmjena poruka
      </text>
      <text x="700" y="1235" textAnchor="middle" fontSize="11" fill={textColor}>
        • Otkrivanje kontakata
      </text>
      <text x="700" y="1250" textAnchor="middle" fontSize="11" fill={textColor}>
        • Dogovor detalja
      </text>
      <text x="700" y="1265" textAnchor="middle" fontSize="11" fill={textColor}>
        ⚠️ Bez oba sudionika nema chata
      </text>
      ...
      <rect x="100" y="1340" width="400" height="60" rx="5" fill={successColor} stroke={borderColor} strokeWidth="2" />
      ...
      <rect x="50" y="1520" width="200" height="140" rx="5" fill={successColor} stroke={borderColor} strokeWidth="2" />
      ...
      <rect x="450" y="1520" width="200" height="120" rx="5" fill={dangerColor} stroke={borderColor} strokeWidth="2" />
  ...
  const QueueSystemFlowchart = () => (
    <ZoomableSVG viewBox="0 0 1400 1200">
      ...
      {/* Partner Score izračun */}
      <rect x="350" y="430" width="700" height="160" rx="5" fill={boxColor} stroke={borderColor} strokeWidth="2" />
      ...
      <rect x="350" y="750" width="300" height="100" rx="5" fill={boxColor} stroke={borderColor} strokeWidth="2" />
      ...
      <text x="400" y="1055" textAnchor="middle" fontSize="12" fill={textColor}>
        Lead ponuđen sljedećem
      </text>
      <text x="400" y="1070" textAnchor="middle" fontSize="12" fill={textColor}>
        Queue se nastavlja
      </text>
      ...
      <text x="700" y="1140" textAnchor="middle" fontSize="14" fontWeight="bold" fill="white">
        SKIPPED
      </text>
      <text x="700" y="1160" textAnchor="middle" fontSize="12" fill="white">
        Pružatelj preskočio
      </text>
      <text x="700" y="1175" textAnchor="middle" fontSize="12" fill="white">
        Lead ponuđen sljedećem
      </text>
