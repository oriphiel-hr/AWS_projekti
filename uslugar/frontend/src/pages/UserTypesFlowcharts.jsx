...
export default function UserTypesFlowcharts() {
  ...
  const UserJourneyFlowchart = () => (
    <ZoomableSVG viewBox="0 0 1200 1520">
      ...
      <line x1="150" y1="1220" x2="150" y2="1280" stroke={textColor} strokeWidth="2" markerEnd="url(#arrowhead4)" />
  ...
  const ProviderJourneyFlowchart = () => (
    <ZoomableSVG viewBox="0 0 1200 1120">
      ...
      <line x1="150" y1="920" x2="150" y2="980" stroke={textColor} strokeWidth="2" markerEnd="url(#arrowhead5)" />
