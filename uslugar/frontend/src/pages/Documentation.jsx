...
const Documentation = () => {
  ...
  // Fallback: Detaljni funkcionalni opisi za korisnike - bez tehničkih detalja
  // Ovo se koristi samo ako API ne vrati podatke (fallback)
...
`
  ...
  // Hardkodirani podaci se više ne koriste - učitavaju se iz baze
  // Ovo je samo za reference - briše se nakon migracije
  const _hardcodedFeatures = [
    {
  ...
  // Koristi featureDescriptions iz state-a, fallback na prazan objekt
  const descriptionsToUse = Object.keys(featureDescriptions).length > 0 
    ? featureDescriptions 
    : fallbackFeatureDescriptions;
    ...
    return (
      <div className={`max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 ${isDarkMode ? 'dark' : ''}`}>
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6 text-center">
          <h2 className="text-xl font-semibold text-red-800 dark:text-red-400 mb-2">Greška</h2>
